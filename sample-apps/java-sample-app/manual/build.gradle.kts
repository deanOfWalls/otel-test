...
dependencies {
    ...
    implementation("io.opentelemetry.contrib:opentelemetry-aws-xray:1.47.0")
    ...
    implementation("io.opentelemetry.instrumentation:opentelemetry-okhttp-3.0:2.17.1-alpha")
